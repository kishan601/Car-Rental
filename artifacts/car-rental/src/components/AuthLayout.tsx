  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 relative">
        ...
        {/* Decorative background elements for mobile/light side */}
        ...
        <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/3 w-96 h-96 bg-accent/5 rounded-full blur-3xl -z-10"></div>
      </div>
    </div>
  );
}
